...
export default function JourneyTimeline({ posts }: Props) {
  ...
  function getMoodText(mood: Post['mood']) {
    switch (mood) {
      case 'excited': return 'Feeling excited about this discovery!'
      case 'confused': return 'Still wrapping my head around this...'
      case 'accomplished': return 'Successfully implemented this concept!'
      case 'struggling': return 'Working through the challenges...'
    }
  }
